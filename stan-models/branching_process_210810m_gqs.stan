...
generated quantities
{
    ...
    int actual_cs_unobs[N_sbts,500];
    ...
    matrix[N_sbts,500] obs_cs_post;
    matrix[N_sbts,N_sgs_m] origins_subgraphs_x;
    matrix[N_sbts,500] origins_subgraphs_e;
    ...
    // generate expected cases by age + expected deaths by age
    {
        ...
        for(s in 1:N_sbts)
        {
            ...
            if(c==1){
                ...
                actual_cs_unobs[s,] =  rep_array(0,500);
            }
           ...
           cs_obs_post_pmf[s,] = exp(cs_obs_post_lpmf[s,2:(max_N_cs_actual)]);
            ...
            if(c==1){
              for(i in 1:500)
              {
                ...
                obs_cs_post[s,] =  rep_row_vector(positive_infinity(),500);
            }
